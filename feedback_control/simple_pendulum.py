# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/90_Simple_pendulum.ipynb.
...
# %% ../nbs/90_Simple_pendulum.ipynb 3
import numpy as np
import matplotlib
...
# %% ../nbs/90_Simple_pendulum.ipynb 20
...
# %% ../nbs/90_Simple_pendulum.ipynb 21
class Load():
    def position(self):
...
# %% ../nbs/90_Simple_pendulum.ipynb 22
class Pendulum(Load):
...
# %% ../nbs/90_Simple_pendulum.ipynb 35
...
# %% ../nbs/90_Simple_pendulum.ipynb 38
...
# %% ../nbs/90_Simple_pendulum.ipynb 53
def wrap(angle):
    "Wraps an angle between -pi and pi."
    return (angle + np.pi) % (2 * np.pi) - np.pi

# %% ../nbs/90_Simple_pendulum.ipynb 54
class DCMotorParams():
...
# %% ../nbs/90_Simple_pendulum.ipynb 63
...
# %% ../nbs/90_Simple_pendulum.ipynb 68
