# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/assignments/90_Simple_pendulum.ipynb.

# %% auto 0
__all__ = ['PendulumParameters', 'Load', 'Pendulum', 'PendulumDrawer', 'AnimatePendulum', 'wrap', 'DCMotorParams', 'DCMotor',
           'MotorController', 'AnimateControlledPendulum']

# %% ../nbs/assignments/90_Simple_pendulum.ipynb 3
import numpy as np
import matplotlib
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 20
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 21
class Load():
    def position(self):
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 22
class Pendulum(Load):
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 35
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 38
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 53
def wrap(angle):
    "Wraps an angle between -pi and pi."
    return (angle + np.pi) % (2 * np.pi) - np.pi

# %% ../nbs/assignments/90_Simple_pendulum.ipynb 54
class DCMotorParams():
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 63
...
# %% ../nbs/assignments/90_Simple_pendulum.ipynb 68
