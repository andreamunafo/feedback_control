# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/91_DC_motor.ipynb.

# %% auto 0
__all__ = ['DCMotorParams', 'DCMotor', 'wrap', 'PID', 'Simulator', 'AnimateControlledPendulum']

# %% ../nbs/91_DC_motor.ipynb 4
import numpy as np
import matplotlib
...
# %% ../nbs/91_DC_motor.ipynb 20
def wrap(angle):
    "Wraps an angle between -pi and pi."
    return (angle + np.pi) % (2 * np.pi) - np.pi

# %% ../nbs/91_DC_motor.ipynb 21
class DCMotorParams():
    def __init__(self, 
                 J=0.01, 
                 b=0.1, 
