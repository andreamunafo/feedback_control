# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/assignments/91_DC_motor.ipynb.

# %% auto 0
__all__ = ['DCMotorParams', 'DCMotor', 'wrap', 'PID', 'Simulator', 'AnimateControlledPendulum']

# %% ../nbs/assignments/91_DC_motor.ipynb 4
import numpy as np
import matplotlib
...
# %% ../nbs/assignments/91_DC_motor.ipynb 9
class DCMotorParams():
...
# %% ../nbs/assignments/91_DC_motor.ipynb 20
def wrap(angle):
    "Wraps an angle between -pi and pi."
    return (angle + np.pi) % (2 * np.pi) - np.pi

# %% ../nbs/assignments/91_DC_motor.ipynb 21
class DCMotorParams():
    def __init__(self, 
                 J=0.01, 
                 b=0.1, 
...
# %% ../nbs/assignments/91_DC_motor.ipynb 22
class DCMotor():
...
# %% ../nbs/assignments/91_DC_motor.ipynb 29
class PID():
    """PID controller."""
...
# %% ../nbs/assignments/91_DC_motor.ipynb 32
class Simulator():
...
# %% ../nbs/assignments/91_DC_motor.ipynb 36
